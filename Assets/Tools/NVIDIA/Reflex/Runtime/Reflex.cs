...
namespace NVIDIA
{
    ...
    public class Reflex : MonoBehaviour
    {
        ...
        [DllImport("GfxPluginNVIDIAReflex", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern NvReflex_Status NvReflex_Plugin_GetLatency(ref NvReflex_LATENCY_RESULT_PARAMS markers);

        [DllImport("GfxPluginNVIDIAReflex", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern NvReflex_Status NvReflex_Plugin_GetSleepStatus(ref NvReflex_GET_SLEEP_STATUS_PARAMS sleepStatusParams);
